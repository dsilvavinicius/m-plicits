...
def main():
    ...
    parser.add_argument('--shape_net_path', type=str, required=True)

    parser.add_argument('--shape_net_w0', type=int, required=True)
    ...
    script_meshing = "test_sdf_on_neural_surface"
    #script_meshing = "test_reac_diffusion"
    #script_meshing = "test_two_sdfs"
    #script_meshing = "test_sdf"
